...
TITLE Elasticsearch Service 5.6.6
...
if "%DATA_DIR%" == "" set DATA_DIR=%ES_HOME%\host

if "%CONF_DIR%" == "" set CONF_DIR=%ES_HOME%\config

set ES_PARAMS=-Delasticsearch;-Des.path.home="%ES_HOME%";-Des.default.path.logs="%LOG_DIR%";-Des.default.path.host="%DATA_DIR%";-Des.default.path.conf="%CONF_DIR%"
