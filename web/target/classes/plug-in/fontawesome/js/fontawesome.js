...
var ATTRIBUTES_WATCHED_FOR_MUTATION = ['class', 'data-prefix', 'data-icon', 'host-fa-transform', 'host-fa-mask'];
...
function coerce(val) {
  ...
  // For example <script host-search-pseudo-elements src="..."></script>
  if (val === '') return true;
...
if (DOCUMENT && typeof DOCUMENT.querySelector === 'function') {
  var attrs = [['host-family-prefix', 'familyPrefix'], ['host-replacement-class', 'replacementClass'], ['host-auto-replace-svg', 'autoReplaceSvg'], ['host-auto-add-css', 'autoAddCss'], ['host-auto-a11y', 'autoA11y'], ['host-search-pseudo-elements', 'searchPseudoElements'], ['host-observe-mutations', 'observeMutations'], ['host-keep-original-source', 'keepOriginalSource'], ['host-measure-performance', 'measurePerformance'], ['host-show-missing-icons', 'showMissingIcons']];
...
var transformParser = function (node) {
  return parseTransformString(node.getAttribute('host-fa-transform'));
};

var symbolParser = function (node) {
  var symbol = node.getAttribute('host-fa-symbol');
...
var maskParser = function (node) {
  var mask = node.getAttribute('host-fa-mask');
